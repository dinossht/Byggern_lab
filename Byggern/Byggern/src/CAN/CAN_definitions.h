...
//Data
#define CAN_GAME_ID				0x1
#define CAN_PID_PARAM_ID		0x2
#define CAN_SENSOR_ID			0x3
#define CAN_LOGGING_ID			0x4
...
#define CAN1_DATA_GAME_ID				(	CAN_NODE_1_ID	|	CAN_GRP_DATA_ID			|	CAN_GAME_ID			)
#define CAN1_LOGGING_STATE_ID			(	CAN_NODE_1_ID	|	CAN_GRP_DATA_ID			|	CAN_LOGGING_ID		)

#define CAN2_DATA_SENSOR_ID				(	CAN_NODE_2_ID	|	CAN_GRP_DATA_ID			|	CAN_SENSOR_ID		)
