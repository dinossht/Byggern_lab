...
#define CAN2_DATA_MOT_CONTROLL_ID		(	CAN_NODE_2_ID	|	CAN_GRP_DATA_ID			|	CAN_MOT_CONTROLL_ID	)

#define CAN3_PS3_JOYSTICK_ID			(	CAN_NODE_3_ID	|	CAN_GRP_PS3_ID			|	CAN_JOYSTICK_ID		)
#define CAN3_PS3_JOYSTICK_ID			(	CAN_NODE_3_ID	|	CAN_GRP_PS3_ID			|	CAN_BUTTONS_ID		)
#define CAN3_PS3_JOYSTICK_ID			(	CAN_NODE_3_ID	|	CAN_GRP_PS3_ID			|	CAN_DPAD_ID			)
